...
class BinaryClockPage extends StatelessWidget {
...
class BinaryTime {
  ...
  BinaryTime(){
    ...
    binaryIntegers = hhmmss
        .split('').map((str) => int.parse(str).toRadixString(2).padLeft(4, '0'))
        .toList();
  }
...
class ClockColumn extends StatelessWidget {
  ...
  ClockColumn({Key key, this.title, this.binaryInteger, this.color, this.rows = 4}) {
    ...
    return Column(
      ...
      children: [
        ...
        ...bits.asMap().entries.map((entry){
          ...
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
                ...
                color: isActive ? color : idx < 4 - rows ? Colors.white.withOpacity(0.2) : Colors.black38
            ),
        ...
        ...[
          ...
          Container(
            child: Text(binaryInteger, style: TextStyle(fontSize: 15, color: color),),)
        ]
      ],
    );
  }
